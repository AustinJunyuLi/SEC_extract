...
> Live contract for Codex or any human working in the folder you selected.
...
| Path | Contract |
|---|---|
| `AGENTS.md` | This live contract for Codex-oriented sessions. |
| `CLAUDE.md` | Same live contract for Claude-oriented sessions. |
